...
from scripts.goodwin_keen import find_eqm_keen, phase_plot_keen, plot_num_keen, _2D_phase_plot_keen
...
if __name__ == '__main__':
    ...
    # Goodwin-Keen Phase Portrait
    t = np.arange(0, 302, 0.01)
    t_eqm = np.arange(0, 10000, 0.01)
    eqm = find_eqm_keen(ICs, t_eqm)

    phase_plot_keen(t, ICs, eqm)
    _2D_phase_plot_keen(t, ICs, eqm)
    # print(eqm)
    #
    # sims = sim_study()
    #
